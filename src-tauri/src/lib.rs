...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            services::outputs::list_output_images,
            services::outputs::output_image_metadata,
            services::outputs::open_output_directory,
            ...
            commands::bind_entry,
            commands::set_cover,
            commands::save_trigger_preview,
            commands::delete_trigger_preview,
